...
class EmailsController
{
    ...
    public static function find_all() 
    {
      ...
      $request_controller = new \Skeletor\Controllers\Client\RequestController( API_LOC . 'cms/pages');
      // set properties
    ...
    public static function find_all_blocks($id) {
      $validated = \Skeletor\Methods\UserService::authenticate_login(array('admin'));
    ...
    public static function find_by_id($id) {
      $validated = \Skeletor\Methods\UserService::authenticate_login(array('admin'));
      \Flight::etag('skeletor-client-view-template');
      $request_controller = new \Skeletor\Controllers\Client\RequestController( API_LOC . 'cms/pages/'  . $id);
      $set_method = $request_controller->setMethodHeader('METHOD_GET');
      $set_method = $request_controller->setAcceptHeader('text/html');
      $request = $request_controller->request();
      Print $request;
      ...
      public static function find_block_by_id($id) {
      $validated = \Skeletor\Methods\UserService::authenticate_login(array('admin'));
      \Flight::etag('skeletor-client-view-template');
      $request_controller = new \Skeletor\Controllers\Client\RequestController( API_LOC . 'cms/pages/'  . $id);
      $set_method = $request_controller->setMethodHeader('METHOD_GET');
    ...
    public static function create_view() {
      $validated = \Skeletor\Methods\UserService::authenticate_login(array('admin'));
      \Flight::etag('skeletor-client-view-template');
      $request_controller = new \Skeletor\Controllers\Client\RequestController( API_LOC . 'cms/page');
      $set_method = $request_controller->setMethodHeader('METHOD_GET');
      $set_method = $request_controller->setAcceptHeader('text/html');
      $request = $request_controller->request();
      Print $request;
