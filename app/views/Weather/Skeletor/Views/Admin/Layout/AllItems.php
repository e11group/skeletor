<?php
namespace Weather\Skeletor\Views\Admin\Layout;
...

{
    ...
    public static function load($page_name, $page_variables) 
    {
     ...
     $page_name = \Weather\Skeletor\appService::createNameVariety($page_name);
      ...
      echo \Weather\Skeletor\appService::getGlobals();
