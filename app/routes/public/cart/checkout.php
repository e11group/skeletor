...
require_once( VENDOR_DIR . 'paypal/includes/config.php');
require_once( VENDOR_DIR . 'paypal/includes/paypal.class.php');
...
$SECFields = array(
					...
					'returnurl' => 'http://localhost/startea/vendor/paypal/samples/DoExpressCheckoutPayment.php', 							// Required.  URL to which the customer will be returned after returning from PayPal.  2048 char max.
					'cancelurl' => 'http://starteadev.texturalapp.com/vendor/paypal/class/cancel.php', 							// Required.  URL to which the customer will be returned if they cancel payment on PayPal's site.
					...
					'hdrimg' => ROOT . 'images/hdrimg.jpg', 							// URL for the image displayed as the header during checkout.  Max size of 750x90.  Should be stored on an https:// server or you'll get a warning message in the browser.
					...
					'brandname' => 'Star Tea', 							// A label that overrides the business name in the PayPal account on the PayPal hosted checkout pages.  127 char max.
...
?>
<script>
window.location='<?php echo $_SESSION['PayPalResult']['REDIRECTURL']; ?>';
</script>
<?php
